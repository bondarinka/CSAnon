...
const getAllMessages = async () => {
  ...
  const queryString = `SELECT messages.message, messages.timestamp, users.username, users.pic_url FROM messages INNER JOIN users ON messages.user_id = users.user_id ORDER BY id DESC LIMIT 100 ;`;
